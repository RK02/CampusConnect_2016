...
//        mNotesPager.setAdapter(mNotesPagerAdapter);
        ...
        page_date.setText(dates.get(book_indicator_helper_array.get(urls_single.size()-1)-1));
        page_description.setText(descriptions.get(book_indicator_helper_array.get(urls_single.size()-1)-1));
        ...
        mNotesPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                page_date.setText(dates.get(book_indicator_helper_array.get(position)-1));
                page_description.setText(descriptions.get(book_indicator_helper_array.get(position)-1));
            }
